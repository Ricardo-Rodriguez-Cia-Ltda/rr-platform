...
La advertencia sobre `quote_confirmed` cambia de texto, no de fuerza: el
riesgo real sigue existiendo, solo cambió de forma. Antes, un falso positivo
disparaba una orden de compra; ahora le manda un cobro real a alguien que no
aceptó comprar — sigue siendo el peor error posible en este nodo.
